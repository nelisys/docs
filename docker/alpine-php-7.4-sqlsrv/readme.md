...
RUN apk del autoconf make g++ unixodbc-dev
...
COPY ./files/docker.conf /etc/php7/php-fpm.d/docker.conf
COPY ./files/www.conf /etc/php7/php-fpm.d/www.conf
COPY ./files/zz-docker.conf /etc/php7/php-fpm.d/zz-docker.conf
